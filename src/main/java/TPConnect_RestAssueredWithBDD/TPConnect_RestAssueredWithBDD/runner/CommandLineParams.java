...
import TPConnect_RestAssueredWithBDD.TPConnect_RestAssueredWithBDD.config.options.KnownEnvironments;
import TPConnect_RestAssueredWithBDD.TPConnect_RestAssueredWithBDD.config.options.KnownEnvironments.EnvironmentValidator;
import org.jetbrains.annotations.NotNull;

import static TPConnect_RestAssueredWithBDD.TPConnect_RestAssueredWithBDD.config.options.KnownEnvironments.TEST;
